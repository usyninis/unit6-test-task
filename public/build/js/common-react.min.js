...
},{"./layout":5,"./steps/index":6,"./steps/step1":7,"./steps/step2":8,"./steps/step3":9}],2:[function(require,module,exports){
...
},{"./lang":4,"./ui/nav":10}],6:[function(require,module,exports){
    ...
    //console.log(this.props);
      ...
      React.createElement("div", {className: "skip-types"}, 
        this.props.types.map(function(type) {
          return (
          React.createElement("div", {onClick: this.props.setStep.bind(null,1), className: "skip-type"}, 
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: rowClassName}, 
        ...
        React.createElement("input", {type: field.type, "data-rule": field.rule, className: "input form__row-input", onFocus: this.onFocus, onChange: this.props.handlerOnInputChange, name: field.name, defaultValue: this.props.value})
      )
    );
  }
    ...
    return (
      React.createElement("form", {className: "form"}, 
        ...
        React.createElement("div", {className: "form__row form__row_w50 form__row_first"}, 
          ...
          React.createElement("input", {type: "text", className: "input form__row-input", name: "date_start"})
        ), 
        React.createElement("div", {className: "form__row form__row_w50 form__row_first"}, 
          React.createElement("label", {className: "form__row-label", for: "date_end"}, "date_end"), 
          React.createElement("input", {type: "text", disabled: this.state.oneDay, className: "input form__row-input", name: "date_end"})
        )
        ), 
        React.createElement("div", {className: "form__row"}, 
  ...
  render: function() {
    ...
    //forms.push(form);
      ...
      React.createElement("div", {className: "s-content-step"}, 
        React.createElement("h2", null, "Данные посетителя"), 
        ...
        React.createElement("h2", null, "Дата"), 
        React.createElement("div", {className: "forms"}, 
