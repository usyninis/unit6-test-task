...
var DatePicker = React.createClass({displayName: "DatePicker",
  render: function() {
    ...
    return (	
	  React.createElement("a", {className: "date-picker"+(inputChecked?" checked":""), onClick: this.props.setDate.bind(null,date)}, label)
	);
  }
});
 ...
 /* componentWillReceiveProps: function(newProps) {
  ...
  render: function() {
	...
	while(i < countDatePickers) {
      if(i==3) datePickers.push(React.createElement("br", null));
	  datePickers.push(React.createElement(DatePicker, {day: i, setDate: this.setStartDate, activeDate: this.state.dateStart}));
	  i++;
	} 
    return (
      React.createElement("form", {className: "form js-date-form"}, 
        React.createElement("input", {type: "hidden", name: "oneDay", value: this.state.oneDay}), 
        
        React.createElement("div", {className: "form__row form__row_w50 form__row_first"}, 
          React.createElement("label", {className: "form__row-label", for: "date_start"}, "Начало действия"), 
          React.createElement("input", {type: "text", className: "input form__row-input", ref: "dateStart", defaultValue: this.state.dateStart, name: "date_start"})
        ), 
        React.createElement("div", {className: "form__row form__row_w50 form__row_last"}, 
          React.createElement("label", {className: "form__row-label", for: "date_end"}, "Окончание действия"), 
          React.createElement("input", {type: "text", disabled: this.state.oneDay==1, ref: "dateEnd", defaultValue: this.state.dateEnd, className: "input form__row-input", name: "date_end"})
        ), 
        
        React.createElement("div", {className: "form__row form__row_end"}, 
		datePickers.map(function(datePicker, i) {
		  return datePicker;
		})
        ), 
        React.createElement("hr", {className: "form__hr"}), 
        React.createElement("div", {className: "form__row form__row_end"}, 
          React.createElement("a", {className: "checkbox"+(this.state.oneDay==1?" checked":""), onClick: this.setOneDay.bind(null,1)}, 
            React.createElement("div", {className: "checkbox__imit"}), 
            React.createElement("div", {className: "checkbox__label"}, "один день")
          ), 
          React.createElement("a", {className: "checkbox"+(this.state.oneDay==0?" checked":""), onClick: this.setOneDay.bind(null,0)}, 
            React.createElement("div", {className: "checkbox__imit"}), 
...
},{"moment":13,"moment/locale/ru":12}],7:[function(require,module,exports){
    ...
    //console.log(this.props);
      ...
      React.createElement("div", {className: "skip-types"}, 
        this.props.types.map(function(type, i) {
          return (
          React.createElement("div", {onClick: this.nextStep.bind(null,type.id), className: "skip-type"+(i==3?" last":"")}, 
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: rowClassName}, 
        ...
        React.createElement("input", {type: field.type, ref: "input", "data-rule": field.rule, "data-masked": field.mask, className: "input form__row-input", onChange: this.handlerOnInputChange, name: field.name, defaultValue: this.props.value})
      )
    );
  }
    ...
    return (
      React.createElement("form", {className: "js-client-form"}, 
        this.props.fields.map(function(field) {
          ...
          return React.createElement(FormRow, {field: field, value: value, validateOn: this.props.validateOn});
        }.bind(this))
      )
    );
  }
 ...
 /* setOneDay: function(oneDay) {
  ...
  render: function() {
    ...
    this.state.appData.clients.map(function(client) {
     //console.log(client);
      forms.push(React.createElement(FormClient, {client: client, validateOn: this.state.validateOn}));
    }.bind(this));
    //forms.push(form);
    //console.log(this.state.appData.oneDay);
      ...
      React.createElement("div", {className: "s-content-step"}, 
        ...
        React.createElement("div", {className: "forms"}, 
          ...
          React.createElement("a", {className: "forms__button-add", onClick: this.addClient}, "Добавить еще одного посетителя?")
        ), 
        React.createElement("h2", {className: "title"}, "Дата"), 
        React.createElement("div", {className: "forms"}, 
          
            React.createElement(FormDate, {dateStart: this.state.appData.dateStart, dateEnd: this.state.appData.dateEnd, oneDay: this.state.appData.oneDay, validateOn: this.state.validateOn})
          
        ), 
        React.createElement("div", {className: "form__row form__row_buttons"}, 
...
},{"./../helper":3,"./form-date":6,"moment":13}],9:[function(require,module,exports){
module.exports = React.createClass({displayName: "exports",
  propTypes: {
    appData: React.PropTypes.object.required
  },
  ...
  render: function() {
   ...
   return (
      ...
      React.createElement("div", {className: "s-content"}, 
      React.createElement("div", {className: "s-content-step"}, 
        React.createElement("h2", {className: "title"}, "Посетитель"), 
     
        
        
        React.createElement("div", {className: "forms"}, 

          React.createElement("label", {className: "form__row-label form__row-label_line"}, "Посетители"), 
          clients.map(function(client) {
            return (
              React.createElement("div", null, 
                React.createElement("div", null, React.createElement("b", null, client.name)), 
                React.createElement("div", {className: "hsk"}, client.company), 
                React.createElement("div", {className: "hsk"}, React.createElement("div", {className: "icon-inline"}, React.createElement("div", {className: "icon-phone"})), client.phone), 
                React.createElement("div", {className: "hsk"}, React.createElement("div", {className: "icon-inline"}, React.createElement("div", {className: "icon-email"})), client.email), 
                React.createElement("br", null)
              )
            );
          }), 

          React.createElement("label", {className: "form__row-label form__row-label_line"}, "Время действия пропуска"), 
          React.createElement("div", null, React.createElement("b", null, dates))

        ), 

        React.createElement("div", {className: "form__row form__row_buttons"}, 
          React.createElement("div", {className: "form__row form__row_w50 form__row_first"}, 
            React.createElement("button", {className: "button button-fw outline", onClick: this.prevStep, type: "button"}, React.createElement("div", {className: "inner"}, "Внести изменения"))
          ), 
          React.createElement("div", {className: "form__row form__row_w50 form__row_last"}, 
            React.createElement("button", {className: "button button-fw", onClick: this.nextStep, type: "button"}, React.createElement("div", {className: "inner"}, "Заказать пропуск"))
          )
        )
  ...
  render: function() {
      ...
      React.createElement("div", {className: "s-content"}, 
        ...
        React.createElement("div", {className: "complete"}, 
          React.createElement("div", {className: "complete__icon"}, 
            React.createElement("div", {className: "icon-success"})
          ), 
          React.createElement("h2", {className: "complete__title"}, "Успех"), 
          React.createElement("div", {className: "complete__description"}, 
          "Данные отправлены на проверку сотрудникам", React.createElement("br", null), 
          "службы безопасности"
          ), 
          React.createElement("a", {className: "complete__link", href: "index.html"}, "Продолжить работу")
        )
        )
      )
  	);
