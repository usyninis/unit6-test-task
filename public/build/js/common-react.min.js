    ...
    return (
      React.createElement("form", {className: "form"}, 
        ...
        React.createElement("div", {className: "form__row form__row_w50 form__row_first"}, 
          ...
          React.createElement("input", {type: "text", className: "input form__row-input", ref: "dateStart", value: this.state.dateStart, name: "date_start"})
        ), 
        React.createElement("div", {className: "form__row form__row_w50 form__row_last"}, 
          ...
          React.createElement("input", {type: "text", disabled: this.state.oneDay, ref: "dateEnd", value: this.state.dateEnd, className: "input form__row-input", name: "date_end"})
        )
        ), 
        React.createElement("div", {className: "form__row"}, 
    ...
    //forms.push(form);
      ...
      React.createElement("div", {className: "s-content-step"}, 
        ...
        React.createElement("div", {className: "forms"}, 
            ...
            React.createElement(FormDate, {dateStart: this.state.appData.dateStart, dateEnd: this.state.appData.dateEnd})
